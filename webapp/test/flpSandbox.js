		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OnlineStationary",
									"targetURL": "#onlinestationaryonlinestationary-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"onlinestationaryonlinestationary-display": {
								"semanticObject": "onlinestationaryonlinestationary",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=onlinestationary.onlinestationary",
									"url": sap.ui.require.toUrl("onlinestationary/onlinestationary")
								}
							}
						}
					}
